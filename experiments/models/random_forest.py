...
if __name__ == "__main__":
    # Command: uv run python experiments/models/random_forest.py <dataset_dir> <true|false>
    
    if len(sys.argv) < 3:
        print("Usage: python random_forest.py <dataset_dir> <sample_weights>")
        sys.exit(1)
    
    dataset_dir = sys.argv[1]
    sample_weights = sys.argv[2].lower() == 'true'

    train_and_test_random_forest(dataset_dir, sample_weights)