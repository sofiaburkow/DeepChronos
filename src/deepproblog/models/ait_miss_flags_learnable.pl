...
t(1.0)::next_attack_phase(P1,P2,P3,phase1) :- P1 = 0, P2 = 0, P3 = 0.
t(0.6)::next_attack_phase(P1,P2,P3,phase2) :- P1 = 1, P2 = 0, P3 = 0.
t(1.0)::next_attack_phase(P1,P2,P3,phase2) :- P1 = 1, P2 = 0, P3 = 0.
t(1.0)::next_attack_phase(P1,P2,P3,phase3) :- P1 = 1, P2 = 1, P3 = 0.
t(1.0)::next_attack_phase(P1,P2,P3,phase4) :- P1 = 1, P2 = 1, P3 = 1.
