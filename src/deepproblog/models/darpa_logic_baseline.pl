...
phase_soft(SrcO,DstO,DPort,Proto,phase1) :- icmp_req(SrcO,DstO,Proto).
phase_soft(SrcO,DstO,DPort,Proto,phase2) :- sadmind_req(SrcO,DstO,DPort,Proto) ; icmp_resp(SrcO,DstO,Proto).
phase_soft(SrcO,DstO,DPort,Proto,phase3) :- sadmind_req(SrcO,DstO,DPort,Proto) ; telnet_req(SrcO,DstO,DPort,Proto).
phase_soft(SrcO,DstO,DPort,Proto,phase4) :- telnet_req(SrcO,DstO,DPort,Proto) ; privileged_action(DPort,Proto).
phase_soft(SrcO,DstO,DPort,Proto,phase5) :- mstream(SrcO,DstO,Proto).
...
multi_step(_,P1,P2,P3,P4,SrcO,DstO,DPort,Proto,benign) :-
    \+ (
